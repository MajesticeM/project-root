...
<div class="row">
    ...
    <div class="col-lg-3 profile-header text-right" >
        <button class="btn btn-danger"><a href="<?= base_url('/update-profile') ?>" style="color: white;">Update Portfolio</a></button>
        <br>
    ...
    <div class="row">
        <div class="col-lg-3 profile-info">
            ...
            <ul>
                ...
                <li><b>Height (cm):</b> <?= $athleteProfile['height']; ?></li>
                <li><b>Weight (kg):</b> <?= $athleteProfile['weight']; ?></li>
                <li><b>Gender:</b> <?= $athleteProfile['gender']; ?></li>
                <li><b>Country:</b> <?= $athleteProfile['country']; ?></li>
                <li><b>Wingspan:</b> <?= $athleteProfile['wingspan']; ?></li>
            </ul>
        ...
        <div class="col-lg-9">
            ...
            <div id="about" class="tab-content" style="display: block;">
                ...
                <p><b>Country:</b> <?= $athleteProfile['country']; ?></p>
                <p><b>Bio:</b> <?= $athleteProfile['bio']; ?></p>
                <p><b>Reasons for the love of the specific sport:</b> <?= $athleteProfile['sportReasons']; ?></p>
                <p><b>Motivation to study in USA:</b> <?= $athleteProfile['prospective_university']; ?></p>
                <p><b>Long term goals:</b> <?= $athleteProfile['longTermGoals']; ?></p>
            </div>
            ...
            <div id="contact" class="tab-content">
                ...
                <p><b>Parent Cellphone Number:</b> <?= $athleteProfile['Parentcel']; ?></p>
                <p><b>Parent Email:</b> <?= $athleteProfile['ParentEmail']; ?></p>
            </div>
            ...
            <div id="achievements" class="tab-content">
                ...
                <p><b>Teams represented internationally:</b> <?= $athleteProfile['teamEvents']; ?></p>
            </div>
        </div>
    </div>
</div>
